...
public final class AndroidUtilities {
    ...
    static {
        sDensity = CourtesyCarApp.getInstance().getResources().getDisplayMetrics().density;
        sPackageName = CourtesyCarApp.getInstance().getPackageName();
    }
...
//                L.d(ex, "unique device id");
    ...
    public static void showToast(final String message) {
        ...
        if (isOnMainThread()) {
            Toast.makeText(CourtesyCarApp.getInstance(), message, Toast.LENGTH_SHORT).show();
        } else {
    ...
    public static void showToast(@StringRes int stringRes, Object... arguments) {
        final Context context = CourtesyCarApp.getInstance().getApplicationContext();
        try {
...
//            L.e(TAG, "showToast Resource Id %s not found. %s ", stringRes, ex.getMessage());
    ...
    public static String getString(int stringRes) {
        try {
            return CourtesyCarApp.getInstance().getString(stringRes);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
